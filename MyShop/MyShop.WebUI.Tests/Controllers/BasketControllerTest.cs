...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "kkajur@yahoo.com", ZipCode = "19203" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("kkajur@yahoo.com", "Forms"), null);
